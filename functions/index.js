...
const notificationMessages = [
  "Aloe Vera soothes sunburns. Discover more remedies on Herb Mate!",
  "Chamomile: More than tea – a remedy for insomnia. Learn more!",
  "Checked Ginger's benefits? Great for digestion. Explore on Herb Mate!",
  "Lavender tip: Aids relaxation and sleep. Dive in now!",
  "Nature holds many answers. Explore our herbal guides on Herb Mate.",
  "Boost knowledge with our latest herbal entries. Visit Herb Mate!",
  "Updates in our remedies list! Discover what's new on Herb Mate.",
  "From Basil to Turmeric, unveil nature's secrets on Herb Mate.",
  "Tip: Turmeric is anti-inflammatory. Better with black pepper!",
  "Aconite: A powerful herb for pain relief. Explore more on Herb Mate!",
  "Discover the calming properties of Agrimony on Herb Mate!",
  "Unlock the secrets of Aloe for skin health. Dive in now!",
  "Angelica: Nature's remedy for digestion. Learn more on Herb Mate!",
  "Boost heart health with Arjun. Explore on Herb Mate!",
  "Arnica: Your natural solution for bruises and pain. Discover more!",
  "Ashwagandha: Stress relief from nature. Visit Herb Mate!",
  "Astragalus: Enhance your immune system naturally. Learn how!",
  "Barberry: A herbal remedy for digestive health. Explore on Herb Mate!",
  "Basil: Not just for cooking – discover its health benefits!",
  "Bay laurel: Aromatic herb with wellness benefits. Dive in now!",
  "Bilberry: Good for eyes and more. Explore on Herb Mate!",
  "Black Cohosh: Natural relief for menopause. Learn more!",
  "Boswellia: Tackle inflammation the natural way. Visit Herb Mate!",
  ...
  "Butterbur: Say goodbye to migraines. Explore on Herb Mate!",
  "Calendula: Gentle herb for skin and wellness. Dive in now!",
  "California Poppy: Natural aid for relaxation. Visit Herb Mate!",
  ...
  "Cornflower: Herbal beauty secrets. Explore on Herb Mate!",
  ...
  "Dong Quai: Balance hormones naturally. Visit Herb Mate!",
  ...
  "Feverfew: Your migraine solution from nature. Visit Herb Mate!",
  ...
  "Ginseng: Vitality and energy from nature. Visit Herb Mate!",
